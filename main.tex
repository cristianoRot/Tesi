...
\lstset{
    ...
    basicstyle=\color{code_text}\ttfamily\footnotesize\linespread{0.9}\selectfont,
    ...
    xrightmargin=10pt,
    aboveskip=10pt,         % Spazio prima del codice
    belowskip=10pt          % Spazio dopo il codice
}
...
\include{introduzione} % Crea il file introduzione.tex

\clearpage

% Capitolo 1: Ares
\include{capitolo1} % Contenuto: 1.1 Presentazione, 1.2 Motivazioni

\clearpage

% Capitolo 2: Pipeline
\include{capitolo2} % Contenuto: 2.1 HDRP, 2.2 Draw Call/Batching, 2.3 Shader teorico

\clearpage

% Capitolo 3: Profiling
\include{capitolo3} % Contenuto: 3.1 Scena rif, 3.2 Tool Profiling, 3.3 Baseline

\clearpage

% Capitolo 4: Ottimizzazione pratica
\include{capitolo4} % Contenuto: 4.1 Riduzione Draw Call, 4.2 Shader custom, 4.3 Lighting/Baking

\clearpage

% Capitolo 5: Risultati
\include{capitolo5} % Contenuto: 5.1 Analisi comparativa
